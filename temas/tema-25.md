...
8. **El RD 3/2023 no impone método para los parámetros físico-químicos.** Esto lo he verificado en el texto consolidado y es importante para no afirmar de más: decir que «el método oficial del nitrito es la UNE-EN 26777» es **inexacto**. Lo exacto es que la norma UNE es la forma habitual de cumplir los criterios de rendimiento que sí impone el Real Decreto. **Matiz añadido al redactar el tema 33:** hay **una sola excepción** en toda la norma, y no afecta a los parámetros de este tema: la **nota 6 de la tabla 15** llama a la **UNE-EN ISO 8467** *«método de análisis referencia»* de la **oxidabilidad**, aunque admite *«u otro método con resultados equivalentes»*. Para el nitrito, el cloro, el fósforo y el color el RD **no nombra ninguna norma**.
