...
9. **En el supuesto 1 de 1233 y de 1246 no tengo la plantilla de respuestas.** Las preguntas «Análisis de Sodio» (1233) y «Análisis de Calcio» (1246) ofrecen las mismas cuatro opciones: *absorción atómica con generación de hidruros / potenciometría / cromatografía iónica / cromatografía de gases*. **Ninguna es «absorción atómica de llama», que es la respuesta de manual.** Lo único que puedo afirmar con seguridad es que **la opción de hidruros es falsa** para sodio y calcio. Entre potenciometría (electrodo selectivo, tema 24) y cromatografía iónica de cationes (tema 30) **no me pronuncio**: las dos son técnicas reales para esos iones.
   ...
   **Matización desde el tema 27 (1322 C2 #30).** La convocatoria de 2024 vuelve sobre lo mismo, y esta vez con los cuatro cationes agrupados: «Sodio, Potasio, Calcio y Magnesio», con las opciones *cromatografía de gases con fluorescencia / cromatografía iónica para aniones / **cromatografía iónica para cationes** / ninguna de las anteriores es correcta*. Tres cosas cambian respecto de 1233 y 1246:

   - **La potenciometría ya no se ofrece**, así que ahí no hay empate que deshacer: de las cuatro opciones, **la única aplicable a esos cationes es la cromatografía iónica para cationes**.
   - **Se afina el nombre**: no «cromatografía iónica» a secas, sino **«para cationes»**, que es como se separa de la de aniones — los cloruros y sulfatos de 1322 C2 #27.
   - **La absorción atómica de llama sigue sin ofrecerse** en ninguna de las tres convocatorias, pese a ser la respuesta de manual para sodio y calcio y a estar normalizada para calcio y magnesio en la **UNE-EN ISO 7980:2000**.

   **Qué se puede concluir y qué no.** Sigo **sin plantilla de respuestas**, y la opción *«ninguna de las anteriores es correcta»* deja abierta, en rigor, la posibilidad de que el examinador pensara en la absorción atómica de llama y esperase esa salida. Pero **el peso de la evidencia se inclina ahora hacia la cromatografía iónica**: es la única técnica aplicable que el examinador ofrece para los cationes mayoritarios en las **tres** convocatorias, y en la última la nombra con precisión. **Criterio operativo para estudiar: sodio, potasio, calcio y magnesio → cromatografía iónica de cationes (tema 30)**, sabiendo que la absorción atómica de llama los determina igual de bien y que es lo que normaliza la UNE-EN ISO 7980. La duda **se estrecha, no se cierra**.
